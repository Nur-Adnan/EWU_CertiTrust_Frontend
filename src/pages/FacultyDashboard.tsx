...
import Sidebar from "../components/SidebarFaculty";
...
import GradeSubmissionForm from "./GradeSubmission";
  ...
  return (
    <div className="min-h-screen w-full bg-white text-black flex flex-col">
      <header className="flex justify-between items-center px-6 py-4 ">
        <PageTitle title="Faculty Dashboard" className="text-2xl" />
      ...
      <div className="flex flex-1 mt-6">
        ...
        <div className="flex flex-col gap-5 w-full text-left">
          {selectedSection === "Dashboard" && (
            <div className="pl-12 mt-12">
              <Welcome
                ...
                description="Access course materials, manage student progress, and collaborate with colleagues."
              />
            </div>
          )}
          ...
          {selectedSection === "Grade Submission" && (
            <div className="pl-12 mt-12">
              <GradeSubmissionForm />
            </div>
          )}
